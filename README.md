In this project, I created an XGBoost model to predict house prices. The datasets used in this project can be found at: https://www.kaggle.com/c/house-prices-advanced-regression-techniques/data
